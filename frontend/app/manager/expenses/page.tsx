...
import { Search, Filter, Eye, User, DollarSign, Calendar, FileText, CheckCircle, XCircle } from 'lucide-react';
...
export default function ManagerExpensesPage() {
  ...
  const fetchExpenses = async (page = 1, search = '', status = '', category = '') => {
    try {
      setLoading(true);
      console.log('Manager fetching expenses with params:', { page, search, status, category });
      ...
      console.log('Manager expenses API response:', response);

      if (response.success) {
        setExpenses(response.data.expenses);
        setPagination(response.data.pagination);
        console.log('Manager expenses set:', response.data.expenses);
      } else {
        console.error('Manager expenses API returned error:', response.message);
      }
    } catch (error) {
                ...
                <tr>
                  <td colSpan={8} className="table-cell text-center py-8">
                    <div className="text-center">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        No team expenses found matching your criteria.
                      </p>
                    </div>
                  </td>
                </tr>
